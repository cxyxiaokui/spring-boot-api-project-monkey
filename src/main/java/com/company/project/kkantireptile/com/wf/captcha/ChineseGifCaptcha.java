...
import com.company.project.kkantireptile.com.wf.captcha.AbstractChineseCaptcha;
import com.company.project.kkantireptile.com.wf.captcha.GifEncoder;
...
public class ChineseGifCaptcha extends AbstractChineseCaptcha {
    ...
    public boolean out(OutputStream os) {
        ...
        try {
            ...
            com.company.project.kkantireptile.com.wf.captcha.GifEncoder gifEncoder = new GifEncoder();
            gifEncoder.start(os);
